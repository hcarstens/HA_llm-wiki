---
title: "Generative Imagination"
parent: "Scaffolds"
---

# Generative Imagination

> A scaffold for creative output that deliberately violates assumptions to generate novel ideas, then elaborates them with depth and filters for value.
...
Creative writing, brainstorming, ideation, generating novel concepts, any task where originality matters more than analytical rigor.

Use alone — do not combine with additional heuristics, as they degrade performance.

## Related

- [Scaffolds](index.md)
- [Heuristic Algebra](../heuristic-algebra.md)
- [Creativity Campaigns](../experiments/index.md)

## Judgment

**Confidence**: High — Validated in creativity campaigns C1-C5. All 25 heuristics tested in C3 degraded GI's performance.

**Known Disconfirmers**: Limited to creative tasks; may not apply to analytical domains. Requires deliberate violation of assumptions, which can be counterintuitive.